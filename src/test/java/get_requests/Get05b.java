...
//Do Assertion
        ...
        softAssert.assertEquals(jsonPath.getString("data.pantone_value"),"19-1664","url degeri dogru degil");
        softAssert.assertEquals(jsonPath.getString("support.url"),"https://reqres.in/#support-heading","pantone degeri dogru degil");
